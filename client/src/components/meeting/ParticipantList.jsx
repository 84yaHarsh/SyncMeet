...
export const ParticipantList = ({ participants, isOpen, onClose }) => {
    ...
    <div className="w-80 h-full bg-dark-900 border-l border-dark-700 flex flex-col shadow-2xl z-30 animate-fade-in absolute right-0 top-0 bottom-0 sm:relative">
      ...
      <div className="flex-1 overflow-y-auto p-2 custom-scrollbar">
        <div className="flex flex-col gap-1">
          {participants.map((p) => (
            <div key={p.id} className="flex items-center justify-between p-3 hover:bg-dark-800/50 rounded-xl transition-colors">
